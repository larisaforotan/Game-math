  ...
  const pdf: NextPage = () => {
	...
	<div className="flex flex-col h-full justify-center items-center">
	 <a
        ...
        className="flex flex-col items-center justify-center px-2 py-1 my-2 bg-gray-200 rounded-full cursor-pointer dark:bg-dark-200 dark:bg-black-500"
      >
        ...
        <span>برای دانلود فایل پی دی اف مجموعه ها اینجا کلیک کنید.</span>
      </a>
	</div>
	);
  };
